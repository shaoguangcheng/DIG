...
"""
This module includes kinds of errors and warnings used through whole DIG
"""

__all__ = ['NotTrainedError',
...
class NotTrainedError(ValueError, AttributeError):
    """raise exceptions if model is used before fitting.
...
class TrainFailedWarning(RuntimeWarning):
    """Warning class used if there is an error while training the model.
